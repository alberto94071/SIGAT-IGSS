...
export default function ProgramacionClient() {
  ...
  // ── Reprogramación: su contenido se movió a la pestaña Modificaciones ──
    ...
    return (
      <div className="space-y-6">
        ...
        <EnDesarrollo
          ...
          description="Este contenido se movió a la pestaña Modificaciones."
        />
      </div>
    );
  }
  ...
  if (cuatrimestre === null) {
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Programación — Elige el cuatrimestre</h1>
  ...
  // ── Paso final: buscar renglón, ver sub-productos y programar por mes ──
  return (
    <div className="space-y-6">
