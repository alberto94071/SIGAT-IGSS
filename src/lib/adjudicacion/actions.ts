...
import { renglonLookupMap, unidadMedidaLookupMap, normalizaNombre } from "./renglon-utils";
  ...
  return cons.map(c => {
    ...
    for (const item of cItems) {
      ...
      if (existente) {
        ...
        // cruzando por código + nombre (varios insumos sin código real
        // comparten el mismo placeholder, ej. "S/C").
