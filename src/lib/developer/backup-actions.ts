...
import {
  ...
  viaticoSolicitudes, viaticoComisiones, programacionEntradas, pasajesSolicitudes, requisicionesBodega, valesCajaChica,
...
const TABLAS = [
  ...
  { nombre: "viatico_solicitudes", tabla: viaticoSolicitudes },
  { nombre: "viatico_comisiones", tabla: viaticoComisiones },
